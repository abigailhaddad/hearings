#!/usr/bin/env python3
"""
Parse saved Energy & Commerce YouTube HTML to extract complete video dataset for matching
"""
...
def main():
    ...
    print("🎬 Energy & Commerce YouTube Channel Complete Dataset Extraction")
    print("=" * 70)
    ...
    output = {
        'metadata': {
            ...
            'channel': 'House Energy and Commerce Committee',
    ...
    # Save main dataset
    with open('ec_youtube_complete_dataset.json', 'w') as f:
        json.dump(output, f, indent=2)
    
    print(f"\n💾 Complete dataset saved to: ec_youtube_complete_dataset.json")
    ...
    with open('ec_youtube_videos_for_matching.json', 'w') as f:
        json.dump(simplified, f, indent=2)
    
    print(f"💾 Simplified dataset saved to: ec_youtube_videos_for_matching.json")
